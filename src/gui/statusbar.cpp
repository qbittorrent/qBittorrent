    ...
    : QStatusBar(parent)
{
    ...
    m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("firewalled"));
    ...
    m_dlSpeedLbl->setIcon(UIThemeManager::instance()->getIcon("download"));
    ...
    m_upSpeedLbl->setIcon(UIThemeManager::instance()->getIcon("seeding"));
...
void StatusBar::updateConnectionStatus()
{
    ...
    if (!BitTorrent::Session::instance()->isListening()) {
        m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("disconnected"));
        ...
        if (sessionStatus.hasIncomingConnections) {
            // Connection OK
            m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("connected"));
...
{
    if (alternative) {
        m_altSpeedsBtn->setIcon(UIThemeManager::instance()->getIcon("slow"));
        m_altSpeedsBtn->setToolTip(tr("Click to switch to regular speed limits"));
        m_altSpeedsBtn->setDown(true);
    }
    else {
        m_altSpeedsBtn->setIcon(UIThemeManager::instance()->getIcon("slow_off"));
