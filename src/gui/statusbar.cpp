    ...
    : QStatusBar(parent)
{
    ...
    m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("StatusBar.ErrorConnection"));
    ...
    m_dlSpeedLbl->setIcon(UIThemeManager::instance()->getIcon("StatusBar.DownloadSpeed"));
    ...
    m_upSpeedLbl->setIcon(UIThemeManager::instance()->getIcon("StatusBar.UploadSpeed"));
...
void StatusBar::updateConnectionStatus()
{
    ...
    if (!BitTorrent::Session::instance()->isListening()) {
        m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("StatusBar.DisconnectedConnection"));
        ...
        if (sessionStatus.hasIncomingConnections) {
            // Connection OK
            m_connecStatusLblIcon->setIcon(UIThemeManager::instance()->getIcon("StatusBar.ConnectedConnection"));
...
{
    if (alternative) {
        m_altSpeedsBtn->setIcon(UIThemeManager::instance()->getIcon("StatusBar.AlternateSpeed"));
        m_altSpeedsBtn->setToolTip(tr("Click to switch to regular speed limits"));
        m_altSpeedsBtn->setDown(true);
    }
    else {
        m_altSpeedsBtn->setIcon(UIThemeManager::instance()->getIcon("StatusBar.RegularSpeed"));
