...
private:
    ...
    QSpinBox spin_cache, spin_save_resume_data_interval, outgoing_ports_min, outgoing_ports_max,
             spin_list_refresh, spin_maxhalfopen, spin_tracker_port, spin_cache_ttl, spin_auto_unban_interval;
    QCheckBox cb_os_cache, cb_recheck_completed, cb_resolve_countries, cb_resolve_hosts, cb_super_seeding,
              ...
              cb_confirm_torrent_recheck, cb_listen_ipv6, cb_announce_all_trackers, cb_auto_ban_unknown_peer;
