...
namespace {
    static const QLatin1String ACTION_NAME_DEFAULT("activate-context");
    static const QLatin1String ACTION_NAME_OPEN_FINISHED_TORRENT("document-open"); // it must be named as the corresponding FDO icon
    static const QLatin1String DBUS_SERVICE_NAME("org.freedesktop.Notifications");
    static const QLatin1String DBUS_INTERFACE_NAME("org.freedesktop.Notifications");
    static const QLatin1String DBUS_PATH("/org/freedesktop/Notifications");
}
...
//    actions.append(ACTION_NAME_DEFAULT);
    ...
    case Notifier::TorrentFinished:
        ...
        hints[QLatin1String("category")] = QLatin1String("transfer.complete");
        if (capabilities.testFlag(ActionIcons)) {
            hints[QLatin1String("action-icons")] = true;
        }
        break;
    case Notifier::TorrentIOError:
        hints[QLatin1String("category")] = QLatin1String("transfer.error");
        hints[QLatin1String("urgency")] = 2;
        hints[QLatin1String("resident")] = true;
        break;
    case Notifier::UrlDownloadError:
        hints[QLatin1String("category")] = QLatin1String("network.error");
        hints[QLatin1String("urgency")] = 2;
        hints[QLatin1String("resident")] = true;
        break;
    case Notifier::SearchFinished:
         hints[QLatin1String("urgency")] = 0;
         timeout = -1;
         storeNotification = true;
         break;
    default:
