...
#endif
{
    ...
    connect(properties, SIGNAL(trackerlessStateChanged(bool, const QString &)), transferListFilters, SLOT(changeTrackerless(bool, const QString &)));
    connect(BitTorrent::Session::instance(), SIGNAL(trackerAdded(BitTorrent::TorrentHandle *const, const QString &)), transferListFilters, SLOT(addTracker(BitTorrent::TorrentHandle *const, const QString &)));
    ...
    connect(BitTorrent::Session::instance(), SIGNAL(trackerAdded(BitTorrent::TorrentHandle *const, const QString &)), properties, SLOT(loadTrackers(BitTorrent::TorrentHandle *const)));
...
void MainWindow::on_actionCreate_torrent_triggered()
{
    if (createTorrentDlg) {
        ...
        connect(createTorrentDlg, SIGNAL(torrentToSeed(QString, QString, bool)), this, SLOT(addCreatedTorrent(QString, QString)));
    }
}
...
void MainWindow::addCreatedTorrent(const QString &path, const QString &savePath, bool ignoreShareLimits)
{
    BitTorrent::AddTorrentParams params;
    params.savePath = savePath;
    params.skipChecking = true;
    params.ignoreShareRatio = ignoreShareLimits;
    BitTorrent::Session::instance()->addTorrent(path, params);
}
