...
#define NOTIFICATIONS_SETTINGS_KEY(name) SETTINGS_KEY("Notifications/") name
    ...
    const QString KEY_NOTIFICATIONS_ADDEDTORRENT = NOTIFICATIONS_SETTINGS_KEY("AddedTorrent");
    ...
    , m_hasPython(false)
{
    ...
    connect(BitTorrent::Session::instance(), SIGNAL(torrentAdded(BitTorrent::TorrentHandle *const)), this, SLOT(addedTorrent(BitTorrent::TorrentHandle *const)));
...
bool MainWindow::isAddedTorrentNotificationsEnabled() const
{
    return settings()->loadValue(KEY_NOTIFICATIONS_ADDEDTORRENT, false).toBool();
}

void MainWindow::setAddedTorrentNotificationsEnabled(bool value)
{
    settings()->storeValue(KEY_NOTIFICATIONS_ADDEDTORRENT, value);
}
...
void MainWindow::addedTorrent(BitTorrent::TorrentHandle *const torrent) const
{
    if (isAddedTorrentNotificationsEnabled())
