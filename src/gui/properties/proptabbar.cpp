...
#ifndef Q_OS_MAC
            QIcon::fromTheme(QLatin1String("network-server")),
#endif
            tr("Trackers"), parent);
...
#ifndef Q_OS_MAC
            QIcon::fromTheme(QLatin1String("edit-find-user")),
#endif
            tr("Peers"), parent);
...
#ifndef Q_OS_MAC
            QIcon::fromTheme(QLatin1String("inode-directory")),
#endif
            tr("Content"), parent);
...
#ifndef Q_OS_MAC
            QIcon::fromTheme(QLatin1String("office-chart-line")),
#endif
            tr("Speed"), parent);
