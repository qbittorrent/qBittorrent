...
namespace
{
    ...
    const int DIVIDER_1HOUR = HOUR1_SEC / HOUR1_BUF_SIZE;
...
SpeedPlotView::SpeedPlotView(QWidget *parent)
    ...
    , m_averager1Hour(DIVIDER_1HOUR, m_data1Hour)
...
void SpeedPlotView::setPeriod(const TimePeriod period)
{
    ...
    case SpeedPlotView::MIN30:
        ...
        break;
    case SpeedPlotView::HOUR1:
        m_viewablePointsCount = HOUR1_BUF_SIZE;
        m_currentData = &m_data1Hour;
        break;
...
void SpeedPlotView::replot()
{
    if ((m_period == MIN1)
        ...
        || ((m_period == HOUR1) && m_averager1Hour.isReady())
