  ...
  m_loading(false)
{
  ...
  connect(handler, SIGNAL(downloadFinished(QString, QString)), this, SLOT(handleFinishedDownload(QString)));
  connect(handler, SIGNAL(downloadFailed(QString, QString)), this, SLOT(handleDownloadFailure(QString)));
...
bool RssFeed::refresh()
{
  ...
  connect(handler, SIGNAL(downloadFinished(QString)), this, SLOT(handleFinishedDownload(QString)));
  connect(handler, SIGNAL(downloadFailed(QString)), this, SLOT(handleDownloadFailure(QString)));
