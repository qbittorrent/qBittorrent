...
LogPeerWidget::LogPeerWidget(QWidget *parent)
    : QTreeView(parent)
{
    setUniformRowHeights(true);

    m_listModel = new LogPeerModel(this);
    ...
    connect(this, &QWidget::customContextMenuRequested, this, &LogPeerWidget::displayListMenu);
}

void LogPeerWidget::displayListMenu(const QPoint &pos)
{
    QMenu listMenu(this);
...
void LogPeerWidget::keyPressEvent(QKeyEvent *event)
{
...
void LogPeerWidget::copySelection() const
{
    QStringList list;
