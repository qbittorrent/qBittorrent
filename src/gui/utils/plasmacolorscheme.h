...
#ifndef QBT_GUI_UTILS_PLASMACOLORSCHEME_H
#define QBT_GUI_UTILS_PLASMACOLORSCHEME_H
...
public:
    ...
    PlasmaColorScheme(const QProcessEnvironment& env = QProcessEnvironment::systemEnvironment());
    void reload(const QProcessEnvironment& env = QProcessEnvironment::systemEnvironment());

    static const PlasmaColorScheme* instance();
...
private:
    ...
    static QString locateColorThemeFile(const QString &themeName);
...
#endif // QBT_GUI_UTILS_PLASMACOLORSCHEME_H
