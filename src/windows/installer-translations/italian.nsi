...
LangString inst_firewall ${LANG_ITALIAN} "Aggiungi regole al firewall di Windows"
;LangString inst_firewallinfo ${LANG_ENGLISH} "Adding Windows Firewall rule"
LangString inst_firewallinfo ${LANG_ITALIAN} "Aggiunta regole al firewall di Windows"
...
LangString remove_firewall ${LANG_ITALIAN} "Rimuovi regole dal firewall di Windows"
;LangString remove_firewallinfo ${LANG_ENGLISH} "Removing Windows Firewall rule"
LangString remove_firewallinfo ${LANG_ITALIAN} "Rimozione regole dal firewall di Windows"
