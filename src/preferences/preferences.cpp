...
bool Preferences::isDHTPortSameAsBT() const {
  return value("Preferences/Bittorrent/sameDHTPortAsBT", true).toBool();
}

void Preferences::setDHTPortSameAsBT(bool same) {
  setValue("Preferences/Bittorrent/sameDHTPortAsBT", same);
}

int Preferences::getDHTPort() const {
  return value("Preferences/Bittorrent/DHTPort", 6881).toInt();
}

void Preferences::setDHTPort(int port) {
  setValue("Preferences/Bittorrent/DHTPort", port);
}
