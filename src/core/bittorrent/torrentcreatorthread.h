...
public:
    ...
    void create(QString inputPath, QString savePath, QStringList trackers, QStringList urlSeeds, QString comment, bool isPrivate, int pieceSize);
    void abortCreation();
...
signals:
    ...
    void creationSuccess(QString path, QString branchPath);
