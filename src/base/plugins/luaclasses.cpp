...
namespace
{
    ...
    void registerLuaClassTorrent(lua_State *luaState)
    {
        ...
        cls.addProperty("pieceLength", &Torrent::pieceLength);
    ...
    void registerLuaEnumShareLimitsMode(lua_State *luaState)
    {
        ...
        qBittorrentNS.beginNamespace("ShareLimitsMode")
            ...
            .addProperty("Stop", +[] { return BitTorrent::ShareLimitsMode::MatchAny; })
            .addProperty("Remove", +[] { return BitTorrent::ShareLimitsMode::MatchAll; })
            .endNamespace();
    }
