...
BitTorrent::AddTorrentParams BitTorrent::parseAddTorrentParams(const QJsonObject &jsonObj)
{
    const AddTorrentParams params
    {
        ...
        .seedingTimeLimit = jsonObj.value(PARAM_SEEDINGTIMELIMIT).toInt(Torrent::DEFAULT_SEEDING_TIME_LIMIT),
        .inactiveSeedingTimeLimit = jsonObj.value(PARAM_INACTIVESEEDINGTIMELIMIT).toInt(Torrent::DEFAULT_SEEDING_TIME_LIMIT),
        .ratioLimit = jsonObj.value(PARAM_RATIOLIMIT).toDouble(Torrent::DEFAULT_RATIO_LIMIT),
