...
namespace Notifications
{
    ...
    public:
        ...
        // Notifier interface
        virtual void showNotification(const Request &request) const override;
        void showNotification(Notifications::Request &&request) const override;
    ...
    private:
        ...
        static QStringList getActions(const Request &request);
        static QVariantMap getHints(const Request &request);
        ...
        mutable std::map<uint, Request> m_activeNotifications;
        org::freedesktop::Notifications *m_notificationsService;
