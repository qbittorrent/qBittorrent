...
{
    class Request;
    const QString ACTION_NAME_DEFAULT = QLatin1String("default");
    ...
    public:
        ...
        virtual void showNotification(const Request &request) const = 0;
        virtual void showNotification(Request &&request) const;
