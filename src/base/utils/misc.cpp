...
bool Utils::Misc::isTorrentFileAssocSet()
{
...
void Utils::Misc::setTorrentFileAssoc(const bool set)
{
...
bool Utils::Misc::isMagnetLinkAssocSet()
{
    const QSettings settings(u"HKEY_CURRENT_USER\\Software\\Classes"_s, QSettings::NativeFormat);
...
void Utils::Misc::setMagnetLinkAssoc(const bool set)
{
    QSettings settings(u"HKEY_CURRENT_USER\\Software\\Classes"_s, QSettings::NativeFormat);
...
void Utils::Misc::setTorrentFileAssoc()
{
    if (isTorrentFileAssocSet())
        return;
...
void Utils::Misc::setMagnetLinkAssoc()
{
    if (isMagnetLinkAssocSet())
        return;
