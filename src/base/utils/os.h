...
#define WIN_HAS_DEFAULT_PROGRAMS_API
#endif
#endif
...
namespace Utils
{
    namespace OS
    {
        ...
        bool areAssociationsSet() noexcept;
        void setAssociations();
        bool isTorrentFileAssocSet();
        bool isMagnetLinkAssocSet();
        bool isTorrentFileAssocSet();
        bool isMagnetLinkAssocSet();
        void setTorrentFileAssoc(bool value);
        void setMagnetLinkAssoc(bool value);
#ifdef WIN_HAS_DEFAULT_PROGRAMS_API
        void showAssociationRegistrationUI();
#endif
