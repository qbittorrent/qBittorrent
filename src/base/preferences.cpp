...
{
    return value<QTime>(u"Preferences/Scheduler/start_time"_qs);
}

QTime Preferences::getLegacySchedulerEndTime() const
{
    return value<QTime>(u"Preferences/Scheduler/end_time"_qs);
}

Scheduler::Days Preferences::getLegacySchedulerDays() const
{
    return static_cast<Scheduler::Days>(value(u"Preferences/Scheduler/days"_qs, -1));
}

void Preferences::removeLegacySchedulerTimes()
{
    SettingsStorage::instance()->removeValue(u"Preferences/Scheduler/start_time"_qs);
    SettingsStorage::instance()->removeValue(u"Preferences/Scheduler/end_time"_qs);
    SettingsStorage::instance()->removeValue(u"Preferences/Scheduler/days"_qs);
}

int Preferences::getGlobalAltDownloadLimit() const
{
    return value<int>(u"Preferences/Connection/GlobalDLLimitAlt"_qs, 0);
}

int Preferences::getGlobalAltUploadLimit() const
{
    return value<int>(u"Preferences/Connection/GlobalUPLimitAlt"_qs, 0);
}
