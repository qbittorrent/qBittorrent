...
QByteArray Preferences::getWebUIApiKey() const
{
    return value<QByteArray>(u"Preferences/WebUI/APIKey"_s);
}

void Preferences::setWebUIApiKey(const QByteArray &apiKey)
{
