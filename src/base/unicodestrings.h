...
inline const QString C_LOCALE_ALBANIAN = u"Shqip"_s;
...
inline const QString C_LOCALE_BOSNIAN = u"Босански"_s;
...
inline const QString C_LOCALE_KAZAKH = u"Қазақша"_s;
...
inline const QString C_LOCALE_NEPALI = u"नेपाली भाषा"_s;
...
inline const QString C_LOCALE_SERBIAN_LATIN = u"Српски (Latin)"_s;
