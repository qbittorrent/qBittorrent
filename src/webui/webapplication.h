...
private:
    ...
    const QHash<std::pair<QString, QString>, QString> m_allowedMethod =
    {
        ...
        {{u"metafile"_s, u"create"_s}, Http::METHOD_POST},
        {{u"metafile"_s, u"delete"_s}, Http::METHOD_POST},
        {{u"metafile"_s, u"getFile"_s}, Http::METHOD_GET},
        {{u"metafile"_s, u"status"_s}, Http::METHOD_GET},
