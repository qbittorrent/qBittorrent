...
namespace
{
    ...
    QVariantMap getTransferInfo()
    {
        ...
        map[KEY_TRANSFER_EXTERNAL_ADDRESS_V6] = session->getExternalIPv6Address();
        map[KEY_TRANSFER_EXTERNAL_ADDRESS_V4] = session->getExternalIPv4Address();
...
//  - "external_address_v6": external address v6
//  - "external_address_v4": external address v4
