...
void WebApplication::apiKeySessionInitialize()
{
    ...
    if (const QString submittedKey = parseAuthorizationHeader(m_request.headers.value(u"authorization"_s));
        Utils::Password::slowEquals(submittedKey.toUtf8(), m_apiKey.toUtf8()))
    {
