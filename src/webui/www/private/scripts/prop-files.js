...
window.qBittorrent.PropFiles ??= (() => {
    ...
    const onFilePriorityChanged = function(fileIds, priority) {
        // ignore folders
    ...
    const singleFileRename = function(hash, node) {
    ...
    const multiFileRename = function(hash, selectedRows) {
        new MochaUI.Window({
            id: "multiRenamePage",
            icon: "images/qbittorrent-tray.svg",
            title: "QBT_TR(Renaming)QBT_TR[CONTEXT=TorrentContentTreeView]",
    ...
    const onFileRenameHandler = function(selectedRows, selectedNodes) {
