...
Section $(inst_qbt_req) ;"qBittorrent (required)"
  ...
  File "qt.conf"
  File /oname=translations\qt_ar.qm "..\qt-translations\qt_ar.qm"
  File /oname=translations\qt_bg.qm "..\qt-translations\qt_bg.qm"
  File /oname=translations\qt_ca.qm "..\qt-translations\qt_ca.qm"
  File /oname=translations\qt_cs.qm "..\qt-translations\qt_cs.qm"
  File /oname=translations\qt_da.qm "..\qt-translations\qt_da.qm"
  File /oname=translations\qt_de.qm "..\qt-translations\qt_de.qm"
  File /oname=translations\qt_es.qm "..\qt-translations\qt_es.qm"
  File /oname=translations\qt_eu.qm "..\qt-translations\qt_eu.qm"
  File /oname=translations\qt_fa.qm "..\qt-translations\qt_fa.qm"
  File /oname=translations\qt_fi.qm "..\qt-translations\qt_fi.qm"
  File /oname=translations\qt_fr.qm "..\qt-translations\qt_fr.qm"
  File /oname=translations\qt_gl.qm "..\qt-translations\qt_gl.qm"
  File /oname=translations\qt_he.qm "..\qt-translations\qt_he.qm"
  File /oname=translations\qt_hu.qm "..\qt-translations\qt_hu.qm"
  File /oname=translations\qt_it.qm "..\qt-translations\qt_it.qm"
  File /oname=translations\qt_ja.qm "..\qt-translations\qt_ja.qm"
  File /oname=translations\qt_ko.qm "..\qt-translations\qt_ko.qm"
  File /oname=translations\qt_lt.qm "..\qt-translations\qt_lt.qm"
  File /oname=translations\qt_nl.qm "..\qt-translations\qt_nl.qm"
  File /oname=translations\qt_pl.qm "..\qt-translations\qt_pl.qm"
  File /oname=translations\qt_pt.qm "..\qt-translations\qt_pt.qm"
  File /oname=translations\qt_pt_BR.qm "..\qt-translations\qt_pt_BR.qm"
  File /oname=translations\qt_ru.qm "..\qt-translations\qt_ru.qm"
  File /oname=translations\qt_sk.qm "..\qt-translations\qt_sk.qm"
  File /oname=translations\qt_sl.qm "..\qt-translations\qt_sl.qm"
  File /oname=translations\qt_sv.qm "..\qt-translations\qt_sv.qm"
  File /oname=translations\qt_tr.qm "..\qt-translations\qt_tr.qm"
  File /oname=translations\qt_uk.qm "..\qt-translations\qt_uk.qm"
  File /oname=translations\qt_zh_CN.qm "..\qt-translations\qt_zh_CN.qm"
  File /oname=translations\qt_zh_TW.qm "..\qt-translations\qt_zh_TW.qm"
  File /oname=translations\qtbase_ca.qm "..\qt-translations\qtbase_ca.qm"
  File /oname=translations\qtbase_cs.qm "..\qt-translations\qtbase_cs.qm"
  File /oname=translations\qtbase_de.qm "..\qt-translations\qtbase_de.qm"
  File /oname=translations\qtbase_fi.qm "..\qt-translations\qtbase_fi.qm"
  File /oname=translations\qtbase_fr.qm "..\qt-translations\qtbase_fr.qm"
  File /oname=translations\qtbase_he.qm "..\qt-translations\qtbase_he.qm"
  File /oname=translations\qtbase_hu.qm "..\qt-translations\qtbase_hu.qm"
  File /oname=translations\qtbase_it.qm "..\qt-translations\qtbase_it.qm"
  File /oname=translations\qtbase_ja.qm "..\qt-translations\qtbase_ja.qm"
  File /oname=translations\qtbase_ko.qm "..\qt-translations\qtbase_ko.qm"
  File /oname=translations\qtbase_lv.qm "..\qt-translations\qtbase_lv.qm"
  File /oname=translations\qtbase_pl.qm "..\qt-translations\qtbase_pl.qm"
  File /oname=translations\qtbase_ru.qm "..\qt-translations\qtbase_ru.qm"
  File /oname=translations\qtbase_sk.qm "..\qt-translations\qtbase_sk.qm"
  File /oname=translations\qtbase_uk.qm "..\qt-translations\qtbase_uk.qm"
