...
LangString inst_desktop ${LANG_TURKISH} "Masaüstüne kısayol oluştur"
;LangString inst_startmenu ${LANG_ENGLISH} "Create Start Menu Shortcut"
LangString inst_startmenu ${LANG_TURKISH} "Başlangıç menüsüne kısayol oluştur"
...
LangString inst_pathlimit ${LANG_TURKISH} "Windows yol uzunluğu değişkenini etkisizleştir (260 karakterlik MAX_PATH sınırlaması, Windows 10 1607 veya daha güncel sürümü gerektirir)"
;LangString inst_firewallinfo ${LANG_ENGLISH} "Adding Windows Firewall rule"
LangString inst_firewallinfo ${LANG_TURKISH} "Windows Güvenlik Duvarı kuralı ekleniyor"
;LangString inst_warning ${LANG_ENGLISH} "qBittorrent is running. Please close the application before installing."
LangString inst_warning ${LANG_TURKISH} "qBittorrent halihazırda çalışıyor. Lütfen yüklemeden önce uygulamayı kapatın."
;LangString inst_uninstall_question ${LANG_ENGLISH} "Current version will be uninstalled. User settings and torrents will remain intact."
LangString inst_uninstall_question ${LANG_TURKISH} "Yüklü olan sürüm kaldırılacaktır. qBittorrent ayarları ve torrent'ler bozulmadan kalacaktır."
...
LangString inst_requires_win7 ${LANG_TURKISH} "Bu qBittorrent sürümü Windows 7 veya daha üstünü gerektirir."
;LangString inst_requires_win10 ${LANG_ENGLISH} "This installer requires at least Windows 10 1809."
LangString inst_requires_win10 ${LANG_TURKISH}  "Bu yükleyici en az Windows 10 Sürüm 1809 güncellemesini gerektirir."
