...
LangString inst_warning ${LANG_ITALIAN} "qBittorrent è in esecuzione.$\r$\n$\r$\nChiudi l'applicazione qBittorrent prima della nuova installazione."
;LangString inst_uninstall_question ${LANG_ENGLISH} "Current version will be uninstalled. User settings and torrents will remain intact."
LangString inst_uninstall_question ${LANG_ITALIAN} "L'attuale versione di qBittorrent verrà disinstallata.$\r$\n$\r$\nLe impostazioni utente e i torrent rimanno invariati."
