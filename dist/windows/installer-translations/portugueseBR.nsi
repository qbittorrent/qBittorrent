...
LangString inst_pathlimit ${LANG_PORTUGUESEBR} "Desativar limite de caracteres na variável path do Windows (limite de 260 caracteres, requer Windows 10 1067 ou melhor)"
...
LangString inst_requires_64bit ${LANG_PORTUGUESEBR} "Este instalador somente funciona em versões 64-bit do Windows."
